...
# print('hello' - 10)       #str문자열('hello) 과 int정수(10) 는 지원하지 않는다.

# DW  전자엔서 1분기 수익을 계산하려고 합니다.
...
# # quiz) 가로, 세로 길이를 입력하면 방의 넓이를 계산해주는 프로그램을 만들어봅시다.
