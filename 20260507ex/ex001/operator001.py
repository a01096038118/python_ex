...
#quiz) 홀짝 게임하기
# 주먹 쥔 손을 상대방에게 내밀며 손 안에 동전 갯수가 홀수인지 짝수인지 맞추는 게임입니다.
# 손 안에 동전 갯수를 입력하면 짝수는 0 홀수는 1을 출력하는 프로그램을 만들어봅시다.
...
# 하루에 한 사람이 한 명식 감염시키는 것으로 나타났습니다.
