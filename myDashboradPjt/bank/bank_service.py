        ...
        while flag:
            ...
            if menuNum == bank_config.ACCOUNT_LIST:
                ...
                for idx, myAccount in enumerate(myAccounts.keys()):
                    ...
                    for history in myAccounts[myAccount]['histories']:
                        if 'dAmount' in history:
                            ...
                            print(f'{history["wRegDate"]} \t {history["wHistroy"]} \t\t\t\t\t {history["wAmount"]}')
                    print()
                ...
                if root_config.DEV_MOD:
                    print(f'self.load_accounts(): {self.load.accounts()}')
            ...
            #     '''
            #     My Accounts-------------------------------------------
            #     [1]: 3629a9d4-7a69-4a41-875f-f3d9adf98875
            #     [2]: 6a278ca4-e776-4eba-a184-491d5a155d74
            #     ------------------------------------------------------
            #     '''
            #     withdrawalAccountNumber = ''
            #     while True:
            ...
            #         withdrawalAmount = int(input('Enter deposit amount: '))
            #         withdrawalHistory = input('Enter deposit history: ')
            #         withdrawal = {
            #             'wAmount': withdrawalAmount,
            #             'wHistory': withdrawalHistory,
            #             'wRegDate': util_time.getCurrentDateTime(),
            ...
            #             myAccounts[withdrawalAccountNumber]['histories'].insert(0, deposit)
            #             # 최신정보가 제일 위에 나타내기
            #             self.save_accounts(self.accounts)
