...
print(f'math.fabs(-3.1415): {math.fabs(-3.1415)}')    # 절댓값     3.1415
...
print(f'math.trugcdnc(9, 21): {math.gcd(9, 21)}')     # 최대공약수   3
...
randint(n1, n2): n1이상 n2이하의 난수를 발생
randrange(n1, n2): n1이상 n2미만의 난수를 발생
...
import random
print(f'random(): {random.random()}')                      # 0 이상 1미만 난수  0.44533729857
print(f'randint(): {random.randint(0, 9)}')                # 0 이상 9이하 난수  
print(f'randint(): {random.randrange(0, 9)}')              # 0 이상 9미만 난수  
print(f'randint(): {random.sample(range(0, 10),3)}')       # 0 이상 10미만 3개 난수  
