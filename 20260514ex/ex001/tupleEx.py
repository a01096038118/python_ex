...
# 튜플 조회
# '''
# 튜플은 아이템의 수정이 불가하기 때문에 아이템의 삽입, 삭제, 정렬 드의 기능은 없고
# 조회하는 기능을 주로 사용한다.
# '''
# fruits = ('사과', '포도', '수박', '참외', '배', '자두', '복숭아', '바나나')
# print(f'{fruits[3]}')
...
# # 튜플 아이템의 인덱스 조회
# # 튜플 내 특정 아이템의 인덱스를 확인할 때는 인덱스 함수를 사용
# fruits = ('사과', '포도', '수박', '참외', '배', '자두', '복숭아', '바나나')
# print(f'fruits: {fruits.index('바나나')}')

# # quiz) 아이템 값으로 인덱스 출력하기
# # names 튜플에서 사용자가 선수 이름을 입력하면 이름에 해당하는 인덱스를 출력해봅시다.
# names = ('박찬호', '이승엽', '박세리', '박지성', '이순철', '선동열', '손흥민', '김연아')

# inputData = input('이름 입력: ')
# print(f'inputData: {inputData}, index: {names.index(inputData)}')

# 튜플 안의 아이템 유/무 확인하기
# in 과 not in 키워드를 사용하면 튜플 안에 특정 아이템의 존재 유/무를 확인할 수 있다.

# colors = ('Red', 'Orange', 'Yellow', 'Green', 'Blue', 'Indigo', 'Purple')
# print(f'{'Green+' in colors}')

# if 'Green' in colors:
#     print('colors에는 Green 있습니다')

# else:
#     print('colors에는 Green 없습니다')
...
# quiz) 학점 정보 프로그램 만들기
# '''
# scores는 1학기 성적을 튜플로 나타낸 것입니다.
# F 학점이 있으면 ‘경고’를 출력하는 프로그램을 만들자!
# scores = ('A', 'A+', 'B', 'B-', 'F')
# '''
# scores = ('A', 'A+', 'B', 'B-')
# if 'F' in scores:
...
# print(f'animails: {animails[:3]}')    # ('호랑이', '사자', '곰')
# print(f'animails: {animails[1:4]}')   # ('사자', '곰', '여우')
# print(f'animails: {animails[:-2]}')   # ('호랑이', '사자', '곰')
# print(f'animails: {animails[-1:2]}')   # ()
# print(f'animails: {animails[-3:-1]}')   # ('곰', '여우')
...
fruits = ('apple', 'banana', 'plum', 'watermelon', 'peach')
 ...
 '''
# fruits = ('apple', 'banana', 'plum', 'watermelon', 'peach')
# print(f'fruits: {fruits[2:5]}')
#  #- 인덱스 2부터 4까지의 아이템을 출력하시오.
# print(f'fruits: {fruits[0:4]}')
#  #- 인덱스 0부터 3까지의 아이템을 출력하시오.
...
# 리스트와 튜플간 변환(형변화, casting)
'''
불가피하게 튜플 아이템을 수정하려면 리스트로 변환해야 합니다.
