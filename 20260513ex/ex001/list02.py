...
print(f'numbers: {numbers}')          # [1, 2, 3, 4, 5, 6] (오름차순)

numbers.sort(reverse = True)
print(f'numbers: {numbers}')          # [6, 5, 4, 3, 2, 1] (내림차순)
...
# 리스트 순서 뒤집기
# reverse()의 함수를 이용하면 리스트의 아이템을 역순으로 뒤집을 수 있다.
...
sliceAnimails = animails[1:4]
print(f'sliceAnimails: {sliceAnimails}')

# [n:.m] : n 인덱스부터 (m-1) 인덱스까지의 아이템을 슬라이싱(추출)한다.

animails = ['호랑이', '사자', '곰', '여우', '늑대']
print(f'{animails[:3]}')        #  ['호랑이', '사자', '곰'] 
# 인덱스 0부터 2까지 아이템 슬라이싱

animails = ['호랑이', '사자', '곰', '여우', '늑대']
print(f'{animails[3:]}')        #  ['여우', '늑대']
# 인덱스 3부터 끝까지 아이템 슬라이싱

# 뒤에서 2개의 아이템을 슬라이싱
print(f'{animails[len(animails)-2:]}')     # ['여우', '늑대']

print(f'{animails[:-1]}')    # ['호랑이', '사자', '곰', '여우']
print(f'{animails[1:-1]}')   # ['사자', '곰', '여우']

print(f'{animails[:]}')      # ['호랑이', '사자', '곰', '여우', '늑대']
print(f'{animails[::3]}')    # ['호랑이', '곰', '늑대'] -> step
...
# quiz) 다음 요구사항에 맞게 alphabet 리스트를 슬라이싱 하시오.
'''
