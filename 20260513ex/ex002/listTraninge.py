...
# '''
# students = ['정우람', '박으뜸', '배힘찬', '천영웅', '신석기', '배민규', 
#            '전민수', '박건우', '박찬호', '이승엽']
...
# students.remove('박찬호')
# print(f'students = {students}')
# print(f'student: {len(students)}명')

# studentsForHelp = students[:3]
# print(f'studentsForHelp: {students[:3]}')
...
# print(f'students: {students}')
# print(f'students: {len(students)}명')

# # import random
# # random.shuffle(students)
# # print(f'students: {students}')

# idx = students.index('정우람')              #정우람의 idx 값을 알려줘
# students[idx] = '정잘남'
# print(f'students: {students}')
...
보관하고 있는 혈액형의 종류별로 몇 팩씩 보유하고 있는지
